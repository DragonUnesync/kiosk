...
public final class x extends C0427A {
    private static final C1082c logger = d.getInstance((Class<?>) x.class);
    private final boolean allowExtensions;
    private final boolean allowMaskMismatch;
    private String expectedChallengeResponseString;
    private final boolean performMasking;

    public x(URI uri, O o2, String str, boolean z, L l8, int i, boolean z6, boolean z8, long j7) {
    ...
    public C0405x newHandshakeRequest() {
        ...
        if (this.generateOriginHeader) {
            C0847f fVar3 = G.SEC_WEBSOCKET_ORIGIN;
    ...
    public I newWebSocketEncoder() {
        return new C0444l(this.performMasking);
    }

    public H newWebsocketDecoder() {
        return new C0443k(false, this.allowExtensions, maxFramePayloadLength(), this.allowMaskMismatch);
    }
    ...
    public x(URI uri, O o2, String str, boolean z, L l8, int i, boolean z6, boolean z8, long j7, boolean z9) {
        this(uri, o2, str, z, l8, i, z6, z8, j7, z9, true);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public x(URI uri, O o2, String str, boolean z, L l8, int i, boolean z6, boolean z8, long j7, boolean z9, boolean z10) {
