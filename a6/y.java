...
public final class y extends C0427A {
    private static final C1082c logger = d.getInstance((Class<?>) y.class);
    private final boolean allowExtensions;
    private final boolean allowMaskMismatch;
    private String expectedChallengeResponseString;
    private final boolean performMasking;

    public y(URI uri, O o2, String str, boolean z, L l8, int i, boolean z6, boolean z8, long j7) {
        this(uri, o2, str, z, l8, i, z6, z8, j7, false, true);
    }
    ...
    public H newWebsocketDecoder() {
        return new C0447o(false, this.allowExtensions, maxFramePayloadLength(), this.allowMaskMismatch);
    }
    ...
    public y(URI uri, O o2, String str, boolean z, L l8, int i, boolean z6, boolean z8, long j7, boolean z9, boolean z10) {
