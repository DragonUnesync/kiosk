...
public interface IKnoxVpnService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKnoxVpnService {
        ...
        public abstract /* synthetic */ int createConnection(String str);

        public abstract /* synthetic */ List getAllConnections();

        public abstract /* synthetic */ CertificateInfo getCACertificate(String str);

        public abstract /* synthetic */ String getConnection(String str);

        public abstract /* synthetic */ String getErrorString(String str);

        public abstract /* synthetic */ int getState(String str);

        public abstract /* synthetic */ CertificateInfo getUserCertificate(String str);

        public abstract /* synthetic */ int getVpnModeOfOperation(String str);
        ...
        public abstract /* synthetic */ int removeConnection(String str);

        public abstract /* synthetic */ boolean setAutoRetryOnConnectionError(String str, boolean z);

        public abstract /* synthetic */ boolean setCACertificate(String str, byte[] bArr);

        public abstract /* synthetic */ boolean setServerCertValidationUserAcceptanceCriteria(String str, boolean z, List list, int i);

        public abstract /* synthetic */ boolean setUserCertificate(String str, byte[] bArr, String str2);

        public abstract /* synthetic */ int setVpnModeOfOperation(String str, int i);

        public abstract /* synthetic */ int startConnection(String str);

        public abstract /* synthetic */ int stopConnection(String str);
    }
