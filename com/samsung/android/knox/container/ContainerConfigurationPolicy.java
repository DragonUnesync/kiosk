...
public class ContainerConfigurationPolicy {
    ...
    public boolean addHomeShortcutToPersonal(String str, String str2) {
        try {
            ...
            throw new NoSuchMethodError(SupportLibUtils.buildMethodErrorMsg(ContainerConfigurationPolicy.class, "addHomeShortcutToPersonal", new Class[]{cls, cls}, 20));
        }
    }
    ...
    public boolean deleteHomeShortcutFromPersonal(String str, String str2) {
        try {
            ...
            Class<String> cls = String.class;
            throw new NoSuchMethodError(SupportLibUtils.buildMethodErrorMsg(ContainerConfigurationPolicy.class, "deleteHomeShortcutFromPersonal", new Class[]{cls, cls}, 20));
        }
    }
    ...
    public boolean setHibernationTimeout(long j7) {
        try {
            return this.mContainerConfigurationPolicy.setHibernationTimeout(j7);
        } catch (NoSuchMethodError unused) {
